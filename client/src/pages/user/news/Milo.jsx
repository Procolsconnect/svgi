      ...
      <div className={styles.splitContainer}>
        ...
        <div className={styles.infoSection}>
          ...
          <p className={styles.description}>
            A leader of public instruction with a penchant for kleptomania and debate.
            From the collectives of Brooklyn to facing mythological monsters, Milo's journey
            is one of sharp wit, hidden depths, and an unwavering loyalty to his misfit family.
            Whether he's charming a satyr or arguing with an oracle, he's always got something to say.
          </p>
        </div>

        {/* Right Section - Character Card */}
