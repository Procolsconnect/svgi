...
export default function DataTable({ columns, data, onEdit, onDelete }) {
  ...
  const renderCellContent = (column, rowData, rowIndex) => {
    ...
    const mediaKeys = ["media", "image", "image2", "image3", "img", "image_url", "url", "media_url", "images", "gridImages", "logo_url", "imagesCard", "videosCard", "toursCard", "image1", "ug", "pg", "research", "procedure", "video_url", "companies", "video"]
