...
export default function PgAdmin() {
    ...
    const currentConfig = PG_CONFIG[componentId]
            ...
            <div className="admin-section">
                <div className="section-header">
                    <div>
                        ...
                        <h1>PG Programs Admin</h1>
                        <p>Select a component to manage</p>
                    </div>
                </div>
                <div className="component-cards">
                    <div className="component-card" onClick={() => navigate("/admin/admissions/pg/hero")}>
                        <div className="card-icon"><i className="fa fa-image"></i></div>
                        <h3>Hero Section</h3>
                        <p>Main Banner</p>
                    </div>
                    <div className="component-card" onClick={() => navigate("/admin/admissions/pg/courses")}>
                        <div className="card-icon"><i className="fa fa-graduation-cap"></i></div>
                        <h3>Courses</h3>
                        <p>Manage PG Courses</p>
                    </div>
                </div>
            </div>
        )
    ...
    return (
        <div className="admin-section">
            <div className="section-header">
                <button className="back-link" onClick={() => navigate("/admin/admissions/pg")}>← Back</button>
