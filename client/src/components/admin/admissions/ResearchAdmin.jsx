...
export default function ResearchAdmin() {
    ...
    const currentConfig = RESEARCH_CONFIG[componentId]
            ...
            <div className="admin-section">
                <div className="section-header">
                    <div>
                        ...
                        <h1>Research Programs Admin</h1>
                        <p>Select a component to manage</p>
                    </div>
                </div>
                <div className="component-cards">
                    <div className="component-card" onClick={() => navigate("/admin/admissions/research/hero")}>
                        <div className="card-icon"><i className="fa fa-image"></i></div>
                        <h3>Hero Section</h3>
                        <p>Main Banner</p>
                    </div>
                    <div className="component-card" onClick={() => navigate("/admin/admissions/research/courses")}>
                        <div className="card-icon"><i className="fa fa-microscope"></i></div>
                        <h3>Programs</h3>
                        <p>Manage Research Programs</p>
                    </div>
                </div>
            </div>
        )
    ...
    return (
        <div className="admin-section">
            <div className="section-header">
                <button className="back-link" onClick={() => navigate("/admin/admissions/research")}>← Back</button>
