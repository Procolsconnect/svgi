...
export default function CampusOverviewAdmin() {
    ...
    if (!componentId) {
        return (
            ...
            <div className="component-cards">
                <div className="component-card" onClick={() => navigate("/admin/campuslife/overview/hero")}>
    ...
    return (
        <div className="admin-section">
            <div className="section-header">
                <button className="back-link" onClick={() => navigate("/admin/campuslife/overview")}>← Back</button>
