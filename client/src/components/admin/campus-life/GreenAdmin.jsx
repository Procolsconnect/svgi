...
const GREEN_CONFIG = {
    ...
    "gallery": {
        endpoint: "/greensvgiimagegallary",
        title: "Image Gallery",
        limit: 50,
        columns: [
            { key: "index", label: "Sr. No." },
...
export default function GreenAdmin() {
    ...
    const currentConfig = GREEN_CONFIG[componentId]
    ...
    return (
        <div className="admin-section">
            <div className="section-header">
                <button className="back-link" onClick={() => navigate("/admin/campuslife/green")}>← Back</button>
