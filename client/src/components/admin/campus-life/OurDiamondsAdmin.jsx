...
const DIAMOND_CONFIG = {
    "alumni": {
        endpoint: "/alumanistudent",
        title: "Alumni & Student Achievements",
        limit: 50,
        columns: [
...
export default function OurDiamondsAdmin() {
    ...
    const currentConfig = DIAMOND_CONFIG[componentId]
    ...
    return (
        <div className="admin-section">
            <div className="section-header">
                <button className="back-link" onClick={() => navigate("/admin/campuslife/diamonds")}>← Back</button>
