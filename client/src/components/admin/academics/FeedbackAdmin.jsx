...
const FEEDBACK_CONFIG = {
    "hero": {
        endpoint: "/feedbackhero",
        title: "Feedback Hero Section",
        limit: 1,
        columns: [
    ...
    "reviews": {
        ...
        fields: [
            ...
            { name: "image", label: "Student Image", type: "file", required: true },
        ]
    },
    "faq": {
        endpoint: "/faq",
...
export default function FeedbackAdmin() {
    ...
    const currentConfig = FEEDBACK_CONFIG[componentId]
